...
function getOpenSaasSubscriptionStatus(
  ...
  > = {
    ...
    past_due: OpenSaasSubscriptionStatus.PAST_DUE,
    canceled: OpenSaasSubscriptionStatus.CANCELLED,
    unpaid: OpenSaasSubscriptionStatus.NONE,
    incomplete_expired: OpenSaasSubscriptionStatus.NONE,
  ...
  if (
    ...
    return OpenSaasSubscriptionStatus.CANCELLED;
  }
